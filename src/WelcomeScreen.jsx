    ...
    <div className="jumbotron">
      ...
      <div className="row">
        <div className="col-sm-6 col-sm-offset-3">
          <p>This is a basic demonstration of how to build an application to use Gentics Mesh. This example is an React implementation
        and the source is <a href="https://github.com/gentics/mesh-react-example">available on GitHub</a>.</p>
